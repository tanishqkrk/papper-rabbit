...
function AboutUsPage() {
  ...
  const openModal = () => {
    setModalOpen(true);
    document.body.classList.add("modal-open"); // Optional: Add a class to body for styling
  };

  const closeModal = () => {
    setModalOpen(false);
    document.body.classList.remove("modal-open"); // Optional: Remove the body class
  };
      ...
      <div className="dark:bg-black bg-gray-100 flex flex-col items-center justtify-center">
        ...
        <div className="lg:w-[56%] mac:w-[74%] w-full flex flex-col items-center justify-center gap-8 mt-10 p-4">
          ...
          <div className=" text-justify">
            ...
            perferendis molestiae repudiandae rem quibusdam facilis illum rerum
            ea voluptates a minima repellendus, nostrum maxime quo quam iusto
            assumenda culpa. Sed, quasi nesciunt. Omnis minus, dolores aliquam
            libero harum quia accusantium explicabo aperiam culpa eius,
            doloremque dignissimos reiciendis illum magnam. Ea, aliquid fugiat
            architecto, animi cupiditate ex commodi et corporis incidunt cum
            pariatur natus, unde labore. Cupiditate, repellat tempora! Ad
            repellat, quod consequatur atque, iusto maiores exercitationem
            deleniti cum numquam iure quam impedit vitae consectetur asperiores
            ...
            dicta quae. Deleniti aliquam iste tempora hic eveniet ex
            voluptatibus! Odio assumenda doloremque dolore temporibus similique,
            nulla repudiandae officia? Sed, nesciunt iste. veniam laborum quia
            nesciunt natus. Est qui facilis unde perspiciatis, exercitationem
            dolores ex sequi reprehenderit consequuntur!
          </div>
        </div>
